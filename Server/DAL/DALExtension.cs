...
public static class DALExtension
{
    ...
    public static Microsoft.Extensions.DependencyInjection.IServiceCollection AddDAL(this IServiceCollection services, Action<DALOptions> configure = null)
    {
        ...
        services.AddScoped<IDBSession>((services) =>
        {
            ...
            switch (options.DBType)
            {
                ...
                default:
                    ...
                    // Stub for now
                    return new DBSessionMariaDB(services.GetRequiredService<IConfiguration>());
